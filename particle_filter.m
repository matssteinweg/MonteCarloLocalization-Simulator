...
function [S, measurement_info] = particle_filter(S, u, z, association_ground_truth)

% set simulation mode
global KNOWN_ASSOCIATIONS % use association ground truth or perform ML data association
